...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Neocristal" },
      { name: "description", content: "Contact Neocristal for window and door systems. Based in Alicante." },
      { property: "og:title", content: "Contact — Neocristal" },
      { property: "og:description", content: "Tell us about your project — we reply within 24h." },
    ],
  }),
