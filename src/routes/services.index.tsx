...
export const Route = createFileRoute("/services/")({
  head: () => ({
    meta: [
      { title: "Services — Neocristal" },
      {
        name: "description",
        content: "Window and door systems by Neocristal: design, manufacturing and installation.",
      },
      { property: "og:title", content: "Services — Neocristal" },
      {
        property: "og:description",
        content: "Windows and doors, designed and installed for everyday living.",
      },
    ],
  }),
